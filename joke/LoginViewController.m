...
- (void)viewDidLoad {
    ...
    UITextField *loginName = [[UITextField alloc] initWithFrame:CGRectMake(0, 80, self.view.frame.size.width, 40)];
    [loginName setPlaceholder:@"手机号"];
    [loginName setLeftViewMode:(UITextFieldViewModeAlways)];
    [loginName setKeyboardType:(UIKeyboardTypePhonePad)];
    ...
    [loginName setLeftView:nameLeftView];
    ...
    UITextField *loginPwd = [[UITextField alloc] initWithFrame:CGRectMake(0, 121, self.view.frame.size.width, 40)];
    [loginPwd setPlaceholder:@"登录密码"];
    [loginPwd setLeftViewMode:(UITextFieldViewModeAlways)];
    ...
    [loginPwd setLeftView:pwdLeftView];
